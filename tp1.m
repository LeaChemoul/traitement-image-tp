...
printf("Distance minimale �cran 50 pouces HD : %f cm\n\n", distance_min2_2);
printf("Distance minimale �cran 50 pouces Ultra HD : %f cm\n\n", distance_min2_1);

distance_min1_1 = sqrt(((taille_pixel_mm1_1(1)/10)^2)/(2 * (1 - cosd(1/60))));
distance_min1_2 = sqrt(((taille_pixel_mm1_2(1)/10)^2)/(2 * (1 - cosd(1/60))));
printf("Distance minimale �cran 55 pouces HD : %f cm\n\n", distance_min1_2);
printf("Distance minimale �cran 55 pouces Ultra HD : %f cm\n\n", distance_min1_1);

printf("Entre 50 et 55 pouces, il est necessaire de passer en Ultra HD afin de bien distinguer un �cran situ� � 2m\n");
