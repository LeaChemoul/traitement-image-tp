...
monde_conv_h3 = conv2(monde, H3);
lena_conv_h3 = conv2(lena, H3);

dominos_conv_h4 = conv2(dominos, H4);
monde_conv_h4 = conv2(monde, H4);
lena_conv_h4 = conv2(lena, H4);

dominos_conv_h5 = conv2(dominos, H5);
monde_conv_h5 = conv2(monde, H5);
lena_conv_h5 = conv2(lena, H5);
...
saveas(f, "output/conv2_all_h3_h4_h5.png");
...
imshow(monde_conv_h5);
title("monde convoluted with H5");
saveas(f, "output/monde_conv2_h3_h4_h5.png");
...
dominos_conv_h1 = conv2(dominos, H1);
monde_conv_h1 = conv2(monde, H1);
lena_conv_h1 = conv2(lena, H1);

dominos_conv_h2 = conv2(dominos, H2);
monde_conv_h2 = conv2(monde, H2);
lena_conv_h2 = conv2(lena, H2);
